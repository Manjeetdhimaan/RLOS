...
public class ApplicationTokenProvider {
    ...
    public String generateToken(TokenCreationParameters authRequest) {
        ...
        String arn = authRequest.getArn();
        String requestIp = authRequest.getRequestIp();
    ...
    /**
     * This method will be used to initialize the security parameter 
     * in memory HMAC and Encryption keys
     *
